    ...
    <div className="min-h-screen bg-[#050505] text-gray-200">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">2. Legal basis (GDPR / UK GDPR)</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. How we use your data</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. API keys and third-party providers</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">5. International transfers</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">7. Sharing and disclosure</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">8. Cookies and similar technologies</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">9. Children and minors (COPPA / under-16)</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">10. Your rights (GDPR / UK GDPR)</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">11. California and other US state privacy rights (CCPA / CPRA)</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">12. Data Protection Officer (DPO) and EU/UK contact</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">13. Security</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">15. Contact</h2>
