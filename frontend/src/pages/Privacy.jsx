      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          ...
          <p className="text-gray-300 text-sm">
            <strong className="text-gray-100">For content-safety and prohibited uses,</strong> see our <Link to="/aup" className="text-gray-500 hover:text-gray-500 underline">Acceptable Use Policy</Link>. <strong className="text-gray-100">For terms of use and prohibited AI practices,</strong> see our <Link to="/terms" className="text-gray-500 hover:text-gray-500 underline">Terms of Use</Link>.
          </p>
          <p className="text-gray-300 text-sm">
