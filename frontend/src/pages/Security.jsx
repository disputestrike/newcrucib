    ...
    <div className="min-h-screen bg-[#050505] text-gray-200">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Platform security</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Your code and projects</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Fraud and abuse prevention</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">Reporting a security issue</h2>
