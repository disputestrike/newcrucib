    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          ...
          <p>If you believe you have found a security vulnerability in CrucibAI, please report it to us responsibly. Do not disclose it publicly before we have had a chance to address it. Contact: <a href="mailto:security@crucibai.com" className="text-#c0c0c0 hover:text-#d0d0d0 underline">security@crucibai.com</a> (or the contact listed in your Terms/Privacy). We will acknowledge and work with you to resolve the issue.</p>

          <p className="mt-8 text-[#666666] text-sm">
            For privacy and data handling, see our <Link to="/privacy" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Privacy Policy</Link>. For terms of use, see our <Link to="/terms" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Terms of Use</Link>.
          </p>
        </div>
      </div>
    </div>
