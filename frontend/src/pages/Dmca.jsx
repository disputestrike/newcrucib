    ...
    <div className="min-h-screen bg-[#050505] text-gray-200">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">1. Takedown notices</h2>
          <p>If you are a copyright owner or authorized to act on their behalf and believe that content generated, hosted, or made available through CrucibAI infringes your copyright, you may submit a DMCA takedown notice. Your notice must be sent to <a href="mailto:dmca@crucibai.com" className="text-blue-400 hover:text-blue-300 underline">dmca@crucibai.com</a> and must include:</p>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">2. Counter-notice</h2>
          <p>If your content was removed or disabled as a result of a DMCA notice and you believe the removal was mistaken or that you have the right to use the material, you may submit a counter-notice. Your counter-notice must be sent to <a href="mailto:dmca@crucibai.com" className="text-blue-400 hover:text-blue-300 underline">dmca@crucibai.com</a> and must include:</p>
          <ul className="list-disc pl-6 space-y-2 text-gray-300">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. Repeat infringers</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Misrepresentation</h2>
          ...
          <p>For all DMCA and copyright-related inquiries, contact us at <a href="mailto:dmca@crucibai.com" className="text-blue-400 hover:text-blue-300 underline">dmca@crucibai.com</a>.</p>
        </div>
