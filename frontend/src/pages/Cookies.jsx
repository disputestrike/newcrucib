    ...
    <div className="min-h-screen bg-[#050505] text-gray-200">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          <p>This Cookie Policy explains how CrucibAI uses cookies and similar technologies when you use our website and service. It should be read together with our <Link to="/privacy" className="text-blue-400 hover:text-blue-300 underline">Privacy Policy</Link>. Where required by law (e.g. GDPR, ePrivacy), we obtain your consent for non-essential cookies before use.</p>

          <h2 className="text-xl font-semibold text-white mt-8 mb-3">1. What are cookies?</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">2. How we use cookies</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. Duration</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Your choices</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">5. Third-party cookies</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">6. Updates</h2>
