            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-6 rounded-2xl border border-white/10 bg-kimi-bg-card">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:border-kimi-accent outline-none"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-white focus:border-kimi-accent outline-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2.5 rounded-lg bg-zinc-800 border border-zinc-700 text-white placeholder-zinc-500 focus:border-kimi-accent outline-none resize-none"
