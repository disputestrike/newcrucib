    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          ...
          <p>For how we collect and use your data, see our <Link to="/privacy" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Privacy Policy</Link>. For content-safety and prohibited uses, see our <Link to="/aup" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Acceptable Use Policy</Link>. For terms of use, see our <Link to="/terms" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Terms of Use</Link>. For copyright and DMCA, see our <Link to="/dmca" className="text-#c0c0c0 hover:text-#d0d0d0 underline">DMCA & Copyright Policy</Link>. To manage cookies, see our <Link to="/cookies" className="text-#c0c0c0 hover:text-#d0d0d0 underline">Cookie Policy</Link>.</p>
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link to="/" className="inline-flex items-center gap-1 text-#c0c0c0 hover:text-#d0d0d0 font-medium">← Back to home</Link>
          <Link to="/pricing" className="inline-flex items-center gap-1 text-#c0c0c0 hover:text-#d0d0d0 font-medium">Pricing</Link>
          <Link to="/enterprise" className="inline-flex items-center gap-1 text-#c0c0c0 hover:text-#d0d0d0 font-medium">Enterprise</Link>
        </div>
      </div>
    </div>
  );
