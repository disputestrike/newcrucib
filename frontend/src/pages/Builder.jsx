      ...
      return (
        <button
          ...
          className={`w-full flex items-center gap-2 px-2 py-1.5 text-sm hover:bg-gray-100 rounded transition ${
            selectedFile === item.path ? 'bg-blue-50 text-blue-600' : 'text-gray-700'
          }`}
              ...
              <div className="max-w-2xl w-full text-center">
                ...
                <form onSubmit={(e) => { e.preventDefault(); generateCode(); }} className="space-y-4">
                  <textarea
                    ...
                    className="w-full h-32 px-4 py-3 border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none resize-none text-lg"
                ...
                <div className="mt-8 grid grid-cols-2 gap-4 text-left">
                  {[
                    ...
                    <button
                      ...
                      className="p-3 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition text-sm text-gray-600"
                    >
                      {example}
                    </button>
                  ))}
          ...
          <div className="w-[500px] flex flex-col bg-white">
            ...
            <div className="flex-1 border-b border-gray-200 flex flex-col">
              ...
              <div className="flex-1 bg-white p-4">
                {buildPhase === 'complete' ? (
                  <div className="h-full border border-gray-200 rounded-lg overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
