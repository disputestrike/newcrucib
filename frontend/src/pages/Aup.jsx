    ...
    <div className="min-h-screen bg-[#050505] text-gray-200">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-gray-200 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">1. Prohibited uses</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">2. EU AI Act and prohibited AI practices</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">3. No replication or IP extraction</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Attribution and branding</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">4. Enforcement</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">6. Appeals</h2>
          ...
          <h2 className="text-xl font-semibold text-white mt-8 mb-3">6. Changes</h2>
