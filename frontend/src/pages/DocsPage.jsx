      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="relative mb-8">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-sm text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-blue-500/50"
          />
        </div>
            ...
            {currentSection && (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  <currentSection.icon size={24} className="text-blue-400" />
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-xl border transition ${
                          isExpanded ? 'border-blue-500/30 bg-zinc-900' : 'border-zinc-800 bg-zinc-900/50 hover:border-zinc-700'
                        }`}
                      >
                        <button
                        ...
                        {isExpanded && (
                          ...
                          >
                            ...
                            <div>
                              ...
                              <pre className="p-3 rounded-lg bg-zinc-950 border border-zinc-800 text-xs font-mono text-blue-400 overflow-x-auto">
                                {ep.response}
                              </pre>
                            </div>
                          </motion.div>
