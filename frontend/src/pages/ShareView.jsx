    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <Link to="/" className="text-[#1A1A1A] hover:text-orange-300">Back to CrucibAI</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          ...
          {project.live_url && (
            <a href={project.live_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 px-3 py-1 bg-gray-200 text-[#1A1A1A] rounded-full hover:bg-orange-500/30">
        ...
        <Link to="/auth" className="inline-block mt-4 text-[#1A1A1A] hover:text-orange-300">Sign in to CrucibAI</Link>
      </div>
    </div>
  );
}
